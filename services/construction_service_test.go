...
func TestConstructionService(t *testing.T) {
	...
	// TODO-Klaytn: The maxFeePerGas and maxPriorityFeePerGas in signedRaw variable are removed. If Klaytn added type to Transaction struct, we need to add type also.
